...
public class HandController : MonoBehaviour
{
    ...
    //Fonction qui g�re l'invocation d'une carte sur le terrain depuis la main
        ...
        if (CheckRaycastHit() == "Slot")
        {
            ...
            if (boardController.containCard is true)
            {
                ...
                if (Input.GetMouseButtonDown(0))
                {
                    ...
                    //Envoie la carte selectionn� sur un emplacement d�j� pris
                    ...
                    //Envoie la carte vis�e � l'ancien emplacement de la carte selectionn�
