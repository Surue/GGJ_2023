...
// Reference: https://github.com/redbluegames/unity-notnullattribute
...
namespace OSG
{
    ...
    public class NotNullPropertyDrawer : PropertyDrawer
    {
        ...
        private void BuildWarningRectangle(Rect drawArea, SerializedProperty property)
        {
            ...
            {
                EditorGUI.HelpBox(drawArea, ((NotNullAttribute)this.attribute).message, MessageType.Error);
            }
        }
    }
}
